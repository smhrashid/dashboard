    ...
    <footer class='row'>
        ...
        <p class='col-md-3 col-sm-3 col-xs-12 powered-by'>Powered by: <a
                href='#'><image src='<?php echo base_url();?>asset/images/pragati_life_office_circular.png' /></a></p>
    </footer>
...
<script src="<?php echo base_url();?>asset/datep/jquery-2.js"></script>
<script src="<?php echo base_url();?>asset/datep/datepicker.js"></script>
<script src="<?php echo base_url();?>asset/datep/datepicker_002.js"></script> 
